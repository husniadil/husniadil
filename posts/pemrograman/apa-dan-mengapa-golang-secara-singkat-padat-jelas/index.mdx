...
![Gopher berwarna](./golang-square.webp 'Gopher berwarna')

![Gopher hitam putih](./gopher-hitam-putih.png 'Gopher hitam putih')

![Go Logo](./golang-logo-go.jpg 'Go Logo')
...
Photo by <a rel='noreferrer noopener nofollow' href="https://blog.golang.org">The Go Blog</a>
